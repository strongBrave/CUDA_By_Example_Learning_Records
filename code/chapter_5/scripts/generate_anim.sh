...
# Define variables
ANIM_CU_FILE_PATH="anim.cu"          # Path to the CUDA source file
ANIM_EXE_SAVE_PATH="res/anim"        # Path where the compiled executable will be saved
CONDA_ENV_NAME="gen6d"               # Conda environment name
I2V_PY_PATH="imgs_to_video.py"       # Path to the Python script for converting images to video
IMG_FOLDER="imgs"                  # Directory where the generated frames (images) will be stored
OUTPUT_VIDEO_PATH="anim.mp4"
